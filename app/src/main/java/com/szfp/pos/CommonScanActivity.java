...
import com.szfp.pos.zxing.ScanListener;
import com.szfp.pos.zxing.ScanManager;
import com.szfp.pos.zxing.decode.DecodeThread;
import com.szfp.pos.zxing.decode.Utils;
...
//		Toast.makeText(that, "result="+rawResult.getText(), Toast.LENGTH_LONG).show();
        ...
        Intent intent = new Intent(CommonScanActivity.this,ResultActivity.class);
        Bundle bundle1= new Bundle();
        bundle1.putSerializable("POS",posRecord);
        bundle1.putBoolean("IS",true);
